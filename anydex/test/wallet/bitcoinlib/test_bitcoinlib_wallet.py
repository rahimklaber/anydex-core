...
class TestBitcoinWallet(AbstractServer):
    """
    Tests the functionality of the bitcoin wallet.
    Used as base class for inheritance with other wallets.
    """

    def setUp(self):
        super(TestBitcoinWallet, self).setUp()
        self.wallet = self.new_wallet()
        self.network = 'bitcoin'
        self.network_currency = 'BTC'
        ...
        self.address = '1NxrPk33exXrKSuJFCHHsPVvyAstSg4S7s'
        self.amount = 16250000

    async def tearDown(self):
        # Close all bitcoinlib Wallet DB sessions
        db_session.close_all_sessions()
        os.remove('bcl_config.ini')
        await super(TestBitcoinWallet, self).tearDown()

    def new_wallet(self):
        return BitcoinWallet(self.session_base_dir)

    def test_wallet_name(self):
        """
        Test the name of a wallet
        """
        self.assertEqual(self.wallet.get_name(), self.network)
    ...
    async def test_create_error(self):
        ...
        """
        await self.wallet.create_wallet()  # This should work
...
class TestLitecoinWallet(TestBitcoinWallet):
    """
    Tests the concrete Litecoin wallet implementation.
    """

    def setUp(self):
        super(TestLitecoinWallet, self).setUp()
        self.wallet = self.new_wallet()
        self.network = 'litecoin'
        self.network_currency = 'LTC'
        self.min_unit = 100000
        self.precision = 8
        self.testnet = False
        ...
        self.address = 'MPY1E6E3NALnzX3H3kKEftLpDSEWsdpu2g'
        self.amount = 53972000

    def new_wallet(self):
        return LitecoinWallet(self.session_base_dir)


class TestDashWallet(TestBitcoinWallet):
    """
    Tests the concrete Dash wallet implementation.
    """

    def setUp(self):
        super(TestDashWallet, self).setUp()
        self.wallet = self.new_wallet()
        self.network = 'dash'
        self.network_currency = 'DASH'
        self.min_unit = 100000
        self.precision = 8
        self.testnet = False
        ...
        self.address = 'XxbSMrZBhsRxNfB45pHBohhdaVxsMM8dy3'
        self.amount = 100001

    def new_wallet(self):
        return DashWallet(self.session_base_dir)


class TestBitcoinTestnetWallet(TestBitcoinWallet):
    """
    Tests the testnet Bitcoin wallet implementation.
    """

    def setUp(self):
        super(TestBitcoinTestnetWallet, self).setUp()
        self.wallet = self.new_wallet()
        self.network = 'testnet'
        self.network_currency = 'TBTC'
        self.min_unit = 100000
        self.precision = 8
        self.testnet = True
        ...
        self.raw_tx = \
            ...
            '82af43d2021214f3feffffff029c4e7020000000001976a914d0115029aa5b2d2db7afb54a6c773ad536d0916c88ac' +\
            '90f4f700000000001976a914f0eabff37e597b930647a3ec5e9df2e0fed0ae9888ac108b1500'
        self.address = 'n3Uogo82Tyy76ZNuxmFfhJiFqAUbJ5BPho'
        self.amount = 16250000

    def new_wallet(self):
        return BitcoinTestnetWallet(self.session_base_dir)


class TestLitecoinTestnetWallet(TestBitcoinWallet):
    """
    Tests the testnet Litecoin wallet implementation.
    """

    def setUp(self):
        super(TestLitecoinTestnetWallet, self).setUp()
        self.wallet = self.new_wallet()
        self.network = 'litecoin_testnet'
        self.network_currency = 'XLT'
        self.min_unit = 100000
        self.precision = 8
        self.testnet = True
        ...
        self.address = 'tltc1qvlnx2ql3swj70j6wz7fp05y5v0gcp4ugz7zten'
        self.amount = 2500094800

    def new_wallet(self):
        return LitecoinTestnetWallet(self.session_base_dir)


class TestDashTestnetWallet(TestBitcoinWallet):
    """
    Tests the testnet Dash wallet implementation.
    """

    def setUp(self):
        super(TestDashTestnetWallet, self).setUp()
        self.wallet = self.new_wallet()
        self.network = 'dash_testnet'
        self.network_currency = 'TDASH'
        self.min_unit = 100000
        self.precision = 8
        self.testnet = True
        ...
        self.raw_tx = \
            ...
            '000000'
        self.address = 'yLsw8ESinrp5sSHZ9JEbzYME6EcNwBy4HE'
        self.amount = 61803851

    def new_wallet(self):
        return DashTestnetWallet(self.session_base_dir)
