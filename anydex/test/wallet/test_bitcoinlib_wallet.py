...
class TestDashWallet(TestWallet):
    ...
    async def test_get_transactions(self):
        """
        Test whether transactions in bitcoinlib are correctly returned, for DASH wallets.
        """
...
class TestLitecoinWallet(TestWallet):
    ...
    async def test_get_transactions(self):
        """
        Test whether transactions in bitcoinlib are correctly returned, for LTC wallets
        """
        # TODO: unusual address decoding
