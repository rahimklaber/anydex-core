...
class TestWallet(AbstractServer):
    ...
    async def test_correct_transfer(self):
        ...
        wallet.get_balance = lambda: succeed(
            {'available': 100000, 'pending': 0, 'currency': self.network_currency, 'precision': self.precision})
        mock_tx = MockObject()
        mock_tx.hash = 'a' * 20
    ...
    async def test_get_transactions(self):
        ...
        if self.WALLET_UNDER_TEST in [BitcoinWallet, BitcoinTestnetWallet]:
            raw_tx = '02000000014bca66ebc0e3ab0c5c3aec6d0b3895b968497397752977dfd4a2f0bc67db6810000000006b4830450221' \
            ...
            amount = 16250000
        elif self.WALLET_UNDER_TEST in [LitecoinWallet, LitecoinTestnetWallet]:  # TODO: unusual address decoding
            raw_tx = '020000000001047b95e486a4c85541db0743d85022849f05bbb57f3e7dc4ea981a2c5a9622a9f70000000017160014' \
            ...
            amount = 53972000
        elif self.WALLET_UNDER_TEST in [DashWallet, DashTestnetWallet]:  # TODO: input/output common address bug
            raw_tx = '0200000001e2497d3c50e9d01287fe0c26f98bed6f29386a494ae7ce4b96523e9d9b7f46ad0b0000006b4830450221' \
